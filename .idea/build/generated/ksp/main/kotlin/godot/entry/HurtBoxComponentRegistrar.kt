...
@RegisteredClassMetadata(
  ...
  "Khanhs/Egg_Angry/gdj/game/components/HurtBoxComponent.gdj",
  "project-3",
...
public open class HurtBoxComponentRegistrar : ClassRegistrar {
  public override fun register(registry: ClassRegistry): Unit {
    with(registry) {
      registerClass<HurtBoxComponent>(listOf(), HurtBoxComponent::class, false, "Area2D", "HurtBoxComponent", "src/main/java/game/components/HurtBoxComponent.java", "Khanhs/Egg_Angry/gdj/game/components/HurtBoxComponent.gdj") {
