...
@RegisteredClassMetadata(
  ...
  "Khanhs/Egg_Angry/gdj/game/items/weapons/melee/MeleeBehavior.gdj",
  "project-3",
...
public open class MeleeBehaviorRegistrar : ClassRegistrar {
  public override fun register(registry: ClassRegistry): Unit {
    with(registry) {
      registerClass<MeleeBehavior>(listOf("WeaponBehavior"), MeleeBehavior::class, false, "Node2D", "MeleeBehavior", "src/main/java/game/items/weapons/melee/MeleeBehavior.java", "Khanhs/Egg_Angry/gdj/game/items/weapons/melee/MeleeBehavior.gdj") {
