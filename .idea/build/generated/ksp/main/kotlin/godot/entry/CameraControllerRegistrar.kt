...
@RegisteredClassMetadata(
  ...
  "Khanhs/Egg_Angry/gdj/game/arena/CameraController.gdj",
  "project-3",
...
public open class CameraControllerRegistrar : ClassRegistrar {
  public override fun register(registry: ClassRegistry): Unit {
    with(registry) {
      registerClass<CameraController>(listOf(), CameraController::class, false, "Camera2D", "CameraController", "src/main/java/game/arena/CameraController.java", "Khanhs/Egg_Angry/gdj/game/arena/CameraController.gdj") {
