...
@RegisteredClassMetadata(
  ...
  "Khanhs/Egg_Angry/gdj/game/animation/Trail.gdj",
  "project-3",
...
public open class TrailRegistrar : ClassRegistrar {
  public override fun register(registry: ClassRegistry): Unit {
    with(registry) {
      registerClass<Trail>(listOf(), Trail::class, false, "Line2D", "Trail", "src/main/java/game/animation/Trail.java", "Khanhs/Egg_Angry/gdj/game/animation/Trail.gdj") {
