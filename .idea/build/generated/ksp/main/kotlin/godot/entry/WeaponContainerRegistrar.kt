...
@RegisteredClassMetadata(
  ...
  "Khanhs/Egg_Angry/gdj/game/entity/WeaponContainer.gdj",
  "project-3",
...
public open class WeaponContainerRegistrar : ClassRegistrar {
  public override fun register(registry: ClassRegistry): Unit {
    with(registry) {
      registerClass<WeaponContainer>(listOf(), WeaponContainer::class, false, "Node2D", "WeaponContainer", "src/main/java/game/entity/WeaponContainer.java", "Khanhs/Egg_Angry/gdj/game/entity/WeaponContainer.gdj") {
