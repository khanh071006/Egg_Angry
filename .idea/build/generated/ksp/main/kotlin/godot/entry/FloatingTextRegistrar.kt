...
@RegisteredClassMetadata(
  ...
  "Khanhs/Egg_Angry/gdj/game/ui/FloatingText.gdj",
  "project-3",
...
public open class FloatingTextRegistrar : ClassRegistrar {
  public override fun register(registry: ClassRegistry): Unit {
    with(registry) {
      registerClass<FloatingText>(listOf(), FloatingText::class, false, "Node2D", "FloatingText", "src/main/java/game/ui/FloatingText.java", "Khanhs/Egg_Angry/gdj/game/ui/FloatingText.gdj") {
