...
@RegisteredClassMetadata(
  ...
  "Khanhs/Egg_Angry/gdj/game/entity/BaseUnit.gdj",
  "project-3",
...
public open class BaseUnitRegistrar : ClassRegistrar {
  public override fun register(registry: ClassRegistry): Unit {
    with(registry) {
      registerClass<BaseUnit>(listOf(), BaseUnit::class, false, "Area2D", "BaseUnit", "src/main/java/game/entity/BaseUnit.java", "Khanhs/Egg_Angry/gdj/game/entity/BaseUnit.gdj") {
        ...
        property(BaseUnit::stats, OBJECT, OBJECT, "game.resources.units.UnitStats", RESOURCE_TYPE, "UnitStats", godot.core.PropertyUsageFlags.DEFAULT.flag)
      }
    }
  }
}
