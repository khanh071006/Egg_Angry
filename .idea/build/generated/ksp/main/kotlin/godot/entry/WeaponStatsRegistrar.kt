...
@RegisteredClassMetadata(
  ...
  "Khanhs/Egg_Angry/gdj/game/resources/items/weapons/WeaponStats.gdj",
  "project-3",
...
public open class WeaponStatsRegistrar : ClassRegistrar {
  public override fun register(registry: ClassRegistry): Unit {
    with(registry) {
      registerClass<WeaponStats>(listOf(), WeaponStats::class, false, "Resource", "WeaponStats", "src/main/java/game/resources/items/weapons/WeaponStats.java", "Khanhs/Egg_Angry/gdj/game/resources/items/weapons/WeaponStats.gdj") {
