...
@RegisteredClassMetadata(
  ...
  "Khanhs/Egg_Angry/gdj/game/entity/ShootingBehavior.gdj",
  "project-3",
...
public open class ShootingBehaviorRegistrar : ClassRegistrar {
  public override fun register(registry: ClassRegistry): Unit {
    with(registry) {
      registerClass<ShootingBehavior>(listOf(), ShootingBehavior::class, false, "Node2D", "ShootingBehavior", "src/main/java/game/entity/enemies/ShootingBehavior.java", "Khanhs/Egg_Angry/gdj/game/entity/ShootingBehavior.gdj") {
