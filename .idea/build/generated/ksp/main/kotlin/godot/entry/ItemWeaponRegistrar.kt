...
@RegisteredClassMetadata(
  ...
  "Khanhs/Egg_Angry/gdj/game/resources/items/weapons/ItemWeapon.gdj",
  "project-3",
...
public open class ItemWeaponRegistrar : ClassRegistrar {
  public override fun register(registry: ClassRegistry): Unit {
    with(registry) {
      registerClass<ItemWeapon>(listOf("ItemBase"), ItemWeapon::class, false, "Resource", "ItemWeapon", "src/main/java/game/resources/items/weapons/ItemWeapon.java", "Khanhs/Egg_Angry/gdj/game/resources/items/weapons/ItemWeapon.gdj") {
