...
@RegisteredClassMetadata(
  ...
  "Khanhs/Egg_Angry/gdj/game/resources/items/ItemBase.gdj",
  "project-3",
...
public open class ItemBaseRegistrar : ClassRegistrar {
  public override fun register(registry: ClassRegistry): Unit {
    with(registry) {
      registerClass<ItemBase>(listOf(), ItemBase::class, false, "Resource", "ItemBase", "src/main/java/game/resources/items/ItemBase.java", "Khanhs/Egg_Angry/gdj/game/resources/items/ItemBase.gdj") {
