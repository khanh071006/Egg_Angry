...
@RegisteredClassMetadata(
  ...
  "Khanhs/Egg_Angry/gdj/game/entity/ChaserBehavior.gdj",
  "project-3",
...
public open class ChaserBehaviorRegistrar : ClassRegistrar {
  public override fun register(registry: ClassRegistry): Unit {
    with(registry) {
      registerClass<ChaserBehavior>(listOf(), ChaserBehavior::class, false, "Node2D", "ChaserBehavior", "src/main/java/game/entity/enemies/ChaserBehavior.java", "Khanhs/Egg_Angry/gdj/game/entity/ChaserBehavior.gdj") {
