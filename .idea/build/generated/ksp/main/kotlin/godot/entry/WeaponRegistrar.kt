...
@RegisteredClassMetadata(
  ...
  "Khanhs/Egg_Angry/gdj/game/items/weapons/Weapon.gdj",
  "project-3",
...
public open class WeaponRegistrar : ClassRegistrar {
  public override fun register(registry: ClassRegistry): Unit {
    with(registry) {
      registerClass<Weapon>(listOf(), Weapon::class, false, "Node2D", "Weapon", "src/main/java/game/items/weapons/Weapon.java", "Khanhs/Egg_Angry/gdj/game/items/weapons/Weapon.gdj") {
