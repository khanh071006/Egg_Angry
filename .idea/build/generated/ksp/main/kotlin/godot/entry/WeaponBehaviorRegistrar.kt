...
@RegisteredClassMetadata(
  ...
  "Khanhs/Egg_Angry/gdj/game/items/weapons/WeaponBehavior.gdj",
  "project-3",
...
public open class WeaponBehaviorRegistrar : ClassRegistrar {
  public override fun register(registry: ClassRegistry): Unit {
    with(registry) {
      registerClass<WeaponBehavior>(listOf(), WeaponBehavior::class, false, "Node2D", "WeaponBehavior", "src/main/java/game/items/weapons/WeaponBehavior.java", "Khanhs/Egg_Angry/gdj/game/items/weapons/WeaponBehavior.gdj") {
