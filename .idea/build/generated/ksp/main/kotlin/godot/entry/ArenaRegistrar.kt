...
@RegisteredClassMetadata(
  ...
  "Khanhs/Egg_Angry/gdj/game/arena/Arena.gdj",
  "project-3",
...
public open class ArenaRegistrar : ClassRegistrar {
  public override fun register(registry: ClassRegistry): Unit {
    with(registry) {
      registerClass<Arena>(listOf(), Arena::class, false, "Node2D", "Arena", "src/main/java/game/arena/Arena.java", "Khanhs/Egg_Angry/gdj/game/arena/Arena.gdj") {
