...
@RegisteredClassMetadata(
  ...
  "Khanhs/Egg_Angry/gdj/game/entity/Player.gdj",
  "project-3",
...
public open class PlayerRegistrar : ClassRegistrar {
  public override fun register(registry: ClassRegistry): Unit {
    with(registry) {
      registerClass<Player>(listOf("BaseUnit"), Player::class, false, "Area2D", "Player", "src/main/java/game/entity/Player.java", "Khanhs/Egg_Angry/gdj/game/entity/Player.gdj") {
