...
@RegisteredClassMetadata(
  ...
  "Khanhs/Egg_Angry/gdj/game/ui/HealthBar.gdj",
  "project-3",
...
public open class HealthBarRegistrar : ClassRegistrar {
  public override fun register(registry: ClassRegistry): Unit {
    with(registry) {
      registerClass<HealthBar>(listOf(), HealthBar::class, false, "Control", "HealthBar", "src/main/java/game/ui/HealthBar.java", "Khanhs/Egg_Angry/gdj/game/ui/HealthBar.gdj") {
