...
@RegisteredClassMetadata(
  ...
  "Khanhs/Egg_Angry/gdj/game/components/HitBoxComponent.gdj",
  "project-3",
...
public open class HitBoxComponentRegistrar : ClassRegistrar {
  public override fun register(registry: ClassRegistry): Unit {
    with(registry) {
      registerClass<HitBoxComponent>(listOf(), HitBoxComponent::class, false, "Area2D", "HitBoxComponent", "src/main/java/game/components/HitBoxComponent.java", "Khanhs/Egg_Angry/gdj/game/components/HitBoxComponent.gdj") {
