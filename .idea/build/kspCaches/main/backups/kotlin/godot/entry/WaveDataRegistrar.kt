...
import game.resources.waves.WaveData.SpawnType
...
@RegisteredClassMetadata(
  ...
  "src/main/kotlin/game/resources/waves/WaveData.kt",
  "Khanhs/Egg_Angry/gdj/game/resources/waves/WaveData.gdj",
  "project-3",
  ...
  "",
  "game.resources.waves.WaveData.from,game.resources.waves.WaveData.to,game.resources.waves.WaveData.waveTime,game.resources.waves.WaveData.spawnType,game.resources.waves.WaveData.fixedSpawnTime,game.resources.waves.WaveData.minSpawnTime,game.resources.waves.WaveData.maxSpawnTime,game.resources.waves.WaveData.units",
...
public open class WaveDataRegistrar : ClassRegistrar {
  public override fun register(registry: ClassRegistry): Unit {
    with(registry) {
      registerClass<WaveData>(listOf(), WaveData::class, false, "Resource", "WaveData", "src/main/kotlin/game/resources/waves/WaveData.kt", "Khanhs/Egg_Angry/gdj/game/resources/waves/WaveData.gdj") {
        ...
        property(WaveData::spawnType, ENUM<SpawnType>(SpawnType.entries.toTypedArray()), ENUM<SpawnType>(SpawnType.entries.toTypedArray()), "Int", godot.core.PropertyHint.ENUM, "FIXED,RANDOM", godot.core.PropertyUsageFlags.DEFAULT.flag)
        property(WaveData::fixedSpawnTime, FLOAT, DOUBLE, "kotlin.Float", NONE, "", godot.core.PropertyUsageFlags.DEFAULT.flag)
