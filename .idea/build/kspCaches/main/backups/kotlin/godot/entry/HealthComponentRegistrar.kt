...
@RegisteredClassMetadata(
  ...
  "Khanhs/Egg_Angry/gdj/game/components/HealthComponent.gdj",
  "project-3",
...
public open class HealthComponentRegistrar : ClassRegistrar {
  public override fun register(registry: ClassRegistry): Unit {
    with(registry) {
      registerClass<HealthComponent>(listOf(), HealthComponent::class, false, "Node", "HealthComponent", "src/main/java/game/components/HealthComponent.java", "Khanhs/Egg_Angry/gdj/game/components/HealthComponent.gdj") {
