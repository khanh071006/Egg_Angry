...
@RegisteredClassMetadata(
  ...
  "Khanhs/Egg_Angry/gdj/game/entity/Enemy.gdj",
  "project-3",
...
public open class EnemyRegistrar : ClassRegistrar {
  public override fun register(registry: ClassRegistry): Unit {
    with(registry) {
      registerClass<Enemy>(listOf("BaseUnit"), Enemy::class, false, "Area2D", "Enemy", "src/main/java/game/entity/enemies/Enemy.java", "Khanhs/Egg_Angry/gdj/game/entity/Enemy.gdj") {
