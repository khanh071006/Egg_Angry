...
@RegisteredClassMetadata(
  ...
  "Khanhs/Egg_Angry/gdj/game/resources/EnemyStats.gdj",
  "project-3",
...
public open class EnemyStatsRegistrar : ClassRegistrar {
  public override fun register(registry: ClassRegistry): Unit {
    with(registry) {
      registerClass<EnemyStats>(listOf("UnitStats"), EnemyStats::class, false, "Resource", "EnemyStats", "src/main/java/game/resources/units/EnemyStats.java", "Khanhs/Egg_Angry/gdj/game/resources/EnemyStats.gdj") {
