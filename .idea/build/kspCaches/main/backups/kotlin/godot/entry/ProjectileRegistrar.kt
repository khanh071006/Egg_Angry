...
@RegisteredClassMetadata(
  ...
  "Khanhs/Egg_Angry/gdj/game/items/weapons/projectiles/Projectile.gdj",
  "project-3",
...
public open class ProjectileRegistrar : ClassRegistrar {
  public override fun register(registry: ClassRegistry): Unit {
    with(registry) {
      registerClass<Projectile>(listOf(), Projectile::class, false, "Node2D", "Projectile", "src/main/java/game/items/weapons/projectiles/Projectile.java", "Khanhs/Egg_Angry/gdj/game/items/weapons/projectiles/Projectile.gdj") {
