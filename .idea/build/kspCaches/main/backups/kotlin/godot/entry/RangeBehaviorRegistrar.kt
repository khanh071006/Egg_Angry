...
@RegisteredClassMetadata(
  ...
  "Khanhs/Egg_Angry/gdj/game/items/weapons/range/RangeBehavior.gdj",
  "project-3",
...
public open class RangeBehaviorRegistrar : ClassRegistrar {
  public override fun register(registry: ClassRegistry): Unit {
    with(registry) {
      registerClass<RangeBehavior>(listOf("WeaponBehavior"), RangeBehavior::class, false, "Node2D", "RangeBehavior", "src/main/java/game/items/weapons/range/RangeBehavior.java", "Khanhs/Egg_Angry/gdj/game/items/weapons/range/RangeBehavior.gdj") {
