...
@RegisteredClassMetadata(
  ...
  "Khanhs/Egg_Angry/gdj/game/resources/PlayerStats.gdj",
  "project-3",
...
public open class PlayerStatsRegistrar : ClassRegistrar {
  public override fun register(registry: ClassRegistry): Unit {
    with(registry) {
      registerClass<PlayerStats>(listOf("UnitStats"), PlayerStats::class, false, "Resource", "PlayerStats", "src/main/java/game/resources/units/PlayerStats.java", "Khanhs/Egg_Angry/gdj/game/resources/PlayerStats.gdj") {
