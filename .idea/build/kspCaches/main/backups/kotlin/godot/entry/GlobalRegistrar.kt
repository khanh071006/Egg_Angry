...
@RegisteredClassMetadata(
  ...
  "Khanhs/Egg_Angry/gdj/game/autoloads/Global.gdj",
  "project-3",
...
public open class GlobalRegistrar : ClassRegistrar {
  public override fun register(registry: ClassRegistry): Unit {
    with(registry) {
      registerClass<Global>(listOf(), Global::class, false, "Node", "Global", "src/main/java/game/autoloads/Global.java", "Khanhs/Egg_Angry/gdj/game/autoloads/Global.gdj") {
