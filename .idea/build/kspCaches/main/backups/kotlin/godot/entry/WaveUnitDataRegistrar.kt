...
@RegisteredClassMetadata(
  ...
  "src/main/kotlin/game/resources/waves/WaveUnitData.kt",
  "Khanhs/Egg_Angry/gdj/game/resources/waves/WaveUnitData.gdj",
  "project-3",
...
public open class WaveUnitDataRegistrar : ClassRegistrar {
  public override fun register(registry: ClassRegistry): Unit {
    with(registry) {
      registerClass<WaveUnitData>(listOf(), WaveUnitData::class, false, "Resource", "WaveUnitData", "src/main/kotlin/game/resources/waves/WaveUnitData.kt", "Khanhs/Egg_Angry/gdj/game/resources/waves/WaveUnitData.gdj") {
