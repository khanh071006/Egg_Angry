...
@RegisteredClassMetadata(
  ...
  "Khanhs/Egg_Angry/gdj/game/resources/UnitStats.gdj",
  "project-3",
...
public open class UnitStatsRegistrar : ClassRegistrar {
  public override fun register(registry: ClassRegistry): Unit {
    with(registry) {
      registerClass<UnitStats>(listOf(), UnitStats::class, false, "Resource", "UnitStats", "src/main/java/game/resources/units/UnitStats.java", "Khanhs/Egg_Angry/gdj/game/resources/UnitStats.gdj") {
