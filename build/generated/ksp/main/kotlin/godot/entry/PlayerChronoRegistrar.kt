...
@RegisteredClassMetadata(
  ...
  "",
  "game.entity.PlayerChrono.dashDuration,game.entity.PlayerChrono.dashSpeedMulti,game.entity.PlayerChrono.dashCooldown,game.entity.PlayerChrono.stats",
  "game.entity.PlayerChrono._process,game.entity.PlayerChrono._ready,game.entity.PlayerChrono.setFlashMaterial,game.entity.PlayerChrono._on_hurtbox_component_on_damage,game.entity.PlayerChrono._on_flash_timer_timeout,game.entity.PlayerChrono._on_dash_timer_timeout,game.entity.PlayerChrono.stopMovement,game.entity.PlayerChrono.addWeapon,game.entity.PlayerChrono.removeWeapon,game.entity.PlayerChrono.updatePlayerNewWave,game.entity.PlayerChrono._on_hp_regen_timer_timeout",
  true,
)
  ...
  public override fun register(registry: ClassRegistry): Unit {
    with(registry) {
      registerClass<PlayerChrono>(listOf("Player","BaseUnit"), PlayerChrono::class, false, "Area2D", "PlayerChrono", "src/main/java/game/entity/PlayerChrono.java", "gdj/game/entity/PlayerChrono.gdj") {
        ...
        function(PlayerChrono::stopMovement, NIL, KtFunctionArgument(NIL, "kotlin.Unit"), KtRpcConfig(DISABLED.id.toInt(), false, RELIABLE.id.toInt(), 0))
        ...
        function(PlayerChrono::removeWeapon, NIL, OBJECT, KtFunctionArgument(OBJECT, "godot.api.Node", "weapon"), KtFunctionArgument(NIL, "kotlin.Unit"), KtRpcConfig(DISABLED.id.toInt(), false, RELIABLE.id.toInt(), 0))
        function(PlayerChrono::updatePlayerNewWave, NIL, KtFunctionArgument(NIL, "kotlin.Unit"), KtRpcConfig(DISABLED.id.toInt(), false, RELIABLE.id.toInt(), 0))
        function(PlayerChrono::_on_hp_regen_timer_timeout, NIL, KtFunctionArgument(NIL, "kotlin.Unit"), KtRpcConfig(DISABLED.id.toInt(), false, RELIABLE.id.toInt(), 0))
