  ...
  public override fun register(registry: ClassRegistry): Unit {
    with(registry) {
      registerClass<Global>(listOf(), Global::class, false, "Node", "Global", "src/main/java/game/autoloads/Global.java", "gdj/game/autoloads/Global.gdj") {
        ...
        function(Global::calculateTierProbability, OBJECT, INT, OBJECT, KtFunctionArgument(INT, "kotlin.Int", "currentWave"), KtFunctionArgument(OBJECT, "kotlin.collections.MutableMap", "config"), KtFunctionArgument(OBJECT, "kotlin.FloatArray"), KtRpcConfig(DISABLED.id.toInt(), false, RELIABLE.id.toInt(), 0))
        function(Global::getHarvestingCoins, NIL, KtFunctionArgument(NIL, "kotlin.Unit"), KtRpcConfig(DISABLED.id.toInt(), false, RELIABLE.id.toInt(), 0))
        function(Global::selectItemsForOffer, ARRAY, ARRAY, INT, OBJECT, KtFunctionArgument(ARRAY, "godot.core.VariantArray", "itemPool"), KtFunctionArgument(INT, "kotlin.Int", "currentWave"), KtFunctionArgument(OBJECT, "kotlin.collections.MutableMap", "config"), KtFunctionArgument(ARRAY, "godot.core.VariantArray"), KtRpcConfig(DISABLED.id.toInt(), false, RELIABLE.id.toInt(), 0))
