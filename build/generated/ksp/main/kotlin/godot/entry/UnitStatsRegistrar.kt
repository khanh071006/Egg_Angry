...
@RegisteredClassMetadata(
  ...
  "",
  "game.resources.units.UnitStats.unitName,game.resources.units.UnitStats.type,game.resources.units.UnitStats.icon,game.resources.units.UnitStats.health,game.resources.units.UnitStats.healthIncreasePerWave,game.resources.units.UnitStats.damage,game.resources.units.UnitStats.damageIncreasePerWave,game.resources.units.UnitStats.speed,game.resources.units.UnitStats.blockchance,game.resources.units.UnitStats.hpRegen,game.resources.units.UnitStats.lifesteal,game.resources.units.UnitStats.harvesting",
  "",
  true,
)
  ...
  public override fun register(registry: ClassRegistry): Unit {
    with(registry) {
      registerClass<UnitStats>(listOf(), UnitStats::class, false, "Resource", "UnitStats", "src/main/java/game/resources/units/UnitStats.java", "gdj/game/resources/UnitStats.gdj") {
        ...
        property(UnitStats::hpRegen, FLOAT, DOUBLE, "kotlin.Float", NONE, "", godot.core.PropertyUsageFlags.DEFAULT.flag)
