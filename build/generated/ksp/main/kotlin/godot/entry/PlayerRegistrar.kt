...
@RegisteredClassMetadata(
  ...
  "game.entity.Player._process,game.entity.Player._ready,game.entity.Player.setFlashMaterial,game.entity.Player._on_hurtbox_component_on_damage,game.entity.Player._on_flash_timer_timeout,game.entity.Player.applySlow,game.entity.Player._on_dash_timer_timeout,game.entity.Player.stopMovement,game.entity.Player.addWeapon,game.entity.Player.removeWeapon,game.entity.Player.updatePlayerNewWave,game.entity.Player._on_hp_regen_timer_timeout",
  true,
)
  ...
  public override fun register(registry: ClassRegistry): Unit {
    with(registry) {
      registerClass<Player>(listOf("BaseUnit"), Player::class, false, "Area2D", "Player", "src/main/java/game/entity/Player.java", "gdj/game/entity/Player.gdj") {
        ...
        function(Player::setFlashMaterial, NIL, KtFunctionArgument(NIL, "kotlin.Unit"), KtRpcConfig(DISABLED.id.toInt(), false, RELIABLE.id.toInt(), 0))
        ...
        function(Player::applySlow, NIL, FLOAT, FLOAT, KtFunctionArgument(FLOAT, "kotlin.Float", "duration"), KtFunctionArgument(FLOAT, "kotlin.Float", "multiplier"), KtFunctionArgument(NIL, "kotlin.Unit"), KtRpcConfig(DISABLED.id.toInt(), false, RELIABLE.id.toInt(), 0))
        ...
        function(Player::stopMovement, NIL, KtFunctionArgument(NIL, "kotlin.Unit"), KtRpcConfig(DISABLED.id.toInt(), false, RELIABLE.id.toInt(), 0))
        ...
        function(Player::removeWeapon, NIL, OBJECT, KtFunctionArgument(OBJECT, "godot.api.Node", "weapon"), KtFunctionArgument(NIL, "kotlin.Unit"), KtRpcConfig(DISABLED.id.toInt(), false, RELIABLE.id.toInt(), 0))
        function(Player::updatePlayerNewWave, NIL, KtFunctionArgument(NIL, "kotlin.Unit"), KtRpcConfig(DISABLED.id.toInt(), false, RELIABLE.id.toInt(), 0))
        function(Player::_on_hp_regen_timer_timeout, NIL, KtFunctionArgument(NIL, "kotlin.Unit"), KtRpcConfig(DISABLED.id.toInt(), false, RELIABLE.id.toInt(), 0))
