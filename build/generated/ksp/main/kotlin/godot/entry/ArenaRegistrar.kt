...
@RegisteredClassMetadata(
  ...
  "",
  "game.arena.Arena.normalColor,game.arena.Arena.blockColor,game.arena.Arena.critColor,game.arena.Arena.hpColor,game.arena.Arena.upgradePanel,game.arena.Arena.shopPanel,game.arena.Arena.coinsBag",
  "game.arena.Arena._process,game.arena.Arena._ready,game.arena.Arena._on_selection_panel_selection_completed,game.arena.Arena.show_block_text,game.arena.Arena.show_damage_text,game.arena.Arena.show_heal_text,game.arena.Arena._on_wave_completed,game.arena.Arena.spawn_coins,game.arena.Arena.add_gold_deferred,game.arena.Arena.clean_arena,game.arena.Arena.show_upgrades,game.arena.Arena._on_upgrade_selected,game.arena.Arena._on_shop_next_wave,game.arena.Arena.startNewWave",
  true,
)
  ...
  public override fun register(registry: ClassRegistry): Unit {
    with(registry) {
      registerClass<Arena>(listOf(), Arena::class, false, "Node2D", "Arena", "src/main/java/game/arena/Arena.java", "gdj/game/arena/Arena.gdj") {
        ...
        function(Arena::_on_selection_panel_selection_completed, NIL, KtFunctionArgument(NIL, "kotlin.Unit"), KtRpcConfig(DISABLED.id.toInt(), false, RELIABLE.id.toInt(), 0))
        ...
        function(Arena::spawn_coins, NIL, OBJECT, KtFunctionArgument(OBJECT, "game.entity.enemies.core.Enemy", "enemy"), KtFunctionArgument(NIL, "kotlin.Unit"), KtRpcConfig(DISABLED.id.toInt(), false, RELIABLE.id.toInt(), 0))
