...
@RegisteredClassMetadata(
  ...
  "",
  "game.resources.units.EnemyStats.goldDrop,game.resources.units.EnemyStats.blockChance,game.resources.units.EnemyStats.unitName,game.resources.units.EnemyStats.type,game.resources.units.EnemyStats.icon,game.resources.units.EnemyStats.health,game.resources.units.EnemyStats.healthIncreasePerWave,game.resources.units.EnemyStats.damage,game.resources.units.EnemyStats.damageIncreasePerWave,game.resources.units.EnemyStats.speed,game.resources.units.EnemyStats.blockchance,game.resources.units.EnemyStats.hpRegen,game.resources.units.EnemyStats.lifesteal,game.resources.units.EnemyStats.harvesting",
  "",
  true,
)
  ...
  public override fun register(registry: ClassRegistry): Unit {
    with(registry) {
      registerClass<EnemyStats>(listOf("UnitStats"), EnemyStats::class, false, "Resource", "EnemyStats", "src/main/java/game/resources/units/EnemyStats.java", "gdj/game/resources/EnemyStats.gdj") {
        ...
        property(EnemyStats::blockchance, FLOAT, DOUBLE, "kotlin.Float", NONE, "", godot.core.PropertyUsageFlags.DEFAULT.flag)
        property(EnemyStats::hpRegen, FLOAT, DOUBLE, "kotlin.Float", NONE, "", godot.core.PropertyUsageFlags.DEFAULT.flag)
