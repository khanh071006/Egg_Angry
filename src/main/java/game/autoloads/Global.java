...
public class Global extends Node {
	...
	public void _ready() {
		...
		// Lưu ý: Đổi đường dẫn "res://..." bên dưới cho khớp với thư mục chứa ảnh của bạn trong Godot
	...
	public godot.api.Texture2D getTierTexture(UpgradeTier itemTier) {
		...
		switch (itemTier) {
			case COMMON:
				return commonCardTexture;
			case RARE:
				return rareCardTexture;
			case EPIC:
				return epicCardTexture;
			case LEGENDARY:
				return legendaryCardTexture;
			default:
				return commonCardTexture;
		}
	}
